...
# Bot token
TOKEN = '8531603272:AAGdBJvoMi7VuirUAbxsG6Aa__0N6tnmI2w'
bot = telebot.TeleBot(TOKEN)
REQUEST_INTERVAL = 1

# Admins list
ADMIN_IDS = [754041005]  # Replace with actual admin user IDs
...
def send_not_approved_message(chat_id):
    bot.send_message(chat_id, "*8361769076*", parse_mode='Markdown')
